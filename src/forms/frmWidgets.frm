...
Private Sub Form_Load()
    ...
    With treWidgets
        ...
        .Nodes.Add "Regular", tvwChild, "ParagraphBreak", "Paragraph Break", 7
...
Private Sub treWidgets_NodeClick(ByVal Node As ComctlLib.Node)
    ...
    Select Case Node.Key
        Case "Button", "HorizontalRule", "IFrame", "OrderedList", "UnorderedList", "InputButton", "Image", "InputImage", "FieldSet", "TextArea"
        ...
        Case "ParagraphBreak"
            strCmdID = "InsertParagraph"
            
        Case Else
            Exit Sub
    End Select
    
    blnRetVal = frmCode.hdocHTMLDesignDocument.execCommand(strCmdID, True, vntValue)
